    ...
    data: function data() {
        return {
            packet: {
                ...
                thrusters: [{ active: 0, target: 0.0, current: 0.0, pwm_actual: 0 }, { active: 0, target: 0.0, current: 0.0, pwm_actual: 0 }, { active: 0, target: 0.0, current: 0.0, pwm_actual: 0 }, { active: 0, target: 0.0, current: 0.0, pwm_actual: 0 }, { active: 0, target: 0.0, current: 0.0, pwm_actual: 0 }, { active: 0, target: 0.0, current: 0.0, pwm_actual: 0 }, { active: 0, target: 0.0, current: 0.0, pwm_actual: 0 }, { active: 0, target: 0.0, current: 0.0, pwm_actual: 0 }]
            },
            rov: {},
            gamepad: {
                buttons: {
    ...
    mounted: function mounted() {
        ...
        setInterval(function () {
            socket.emit("control-data", {
                gamepad: controls,
                thrusters: [true, true, true, true, true, true, true, true]
            });
        }, 50);
