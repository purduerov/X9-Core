...
},{"core-js/library/fn/object/entries":7}],4:[function(require,module,exports){
"use strict";
...
},{"../modules/core.get-iterator":57,"../modules/es6.string.iterator":60,"../modules/web.dom.iterable":62}],6:[function(require,module,exports){
require('../modules/web.dom.iterable');
require('../modules/es6.string.iterator');
module.exports = require('../modules/core.is-iterable');
},{"../modules/core.is-iterable":58,"../modules/es6.string.iterator":60,"../modules/web.dom.iterable":62}],7:[function(require,module,exports){
require('../../modules/es7.object.entries');
module.exports = require('../../modules/_core').Object.entries;
},{"../../modules/_core":14,"../../modules/es7.object.entries":61}],8:[function(require,module,exports){
...
},{"./_to-index":48,"./_to-iobject":50,"./_to-length":51}],12:[function(require,module,exports){
...
},{"./_cof":13,"./_wks":55}],13:[function(require,module,exports){
...
},{"./_hide":24,"./_object-create":34,"./_property-desc":42,"./_set-to-string-tag":44,"./_wks":55}],30:[function(require,module,exports){
'use strict';
...
},{"./_export":20,"./_has":23,"./_hide":24,"./_iter-create":29,"./_iterators":32,"./_library":33,"./_object-gpo":37,"./_redefine":43,"./_set-to-string-tag":44,"./_wks":55}],31:[function(require,module,exports){
...
},{"./_an-object":10,"./_dom-create":18,"./_enum-bug-keys":19,"./_html":25,"./_object-dps":36,"./_shared-key":45}],35:[function(require,module,exports){
var anObject       = require('./_an-object')
...
},{"./_an-object":10,"./_descriptors":17,"./_ie8-dom-define":26,"./_to-primitive":53}],36:[function(require,module,exports){
var dP       = require('./_object-dp')
...
},{"./_an-object":10,"./_descriptors":17,"./_object-dp":35,"./_object-keys":39}],37:[function(require,module,exports){
...
},{"./_has":23,"./_shared-key":45,"./_to-object":52}],38:[function(require,module,exports){
var has          = require('./_has')
...
},{"./_array-includes":11,"./_has":23,"./_shared-key":45,"./_to-iobject":50}],39:[function(require,module,exports){
...
},{"./_enum-bug-keys":19,"./_object-keys-internal":38}],40:[function(require,module,exports){
...
},{"./_object-keys":39,"./_object-pie":40,"./_to-iobject":50}],42:[function(require,module,exports){
...
},{"./_has":23,"./_object-dp":35,"./_wks":55}],45:[function(require,module,exports){
...
},{"./_global":22}],47:[function(require,module,exports){
...
},{"./_is-object":28}],54:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
},{"./_classof":12,"./_core":14,"./_iterators":32,"./_wks":55}],57:[function(require,module,exports){
var anObject = require('./_an-object')
...
},{"./_an-object":10,"./_core":14,"./core.get-iterator-method":56}],58:[function(require,module,exports){
var classof   = require('./_classof')
  , ITERATOR  = require('./_wks')('iterator')
  , Iterators = require('./_iterators');
...
},{"./_classof":12,"./_core":14,"./_iterators":32,"./_wks":55}],59:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":9,"./_iter-define":30,"./_iter-step":31,"./_iterators":32,"./_to-iobject":50}],60:[function(require,module,exports){
'use strict';
...
},{"./_iter-define":30,"./_string-at":47}],61:[function(require,module,exports){
...
},{"./_export":20,"./_object-to-array":41}],62:[function(require,module,exports){
...
},{"./_global":22,"./_hide":24,"./_iterators":32,"./_wks":55,"./es6.array.iterator":59}],63:[function(require,module,exports){
var Vue // late bind
var version
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app2"}},[_c('div',{attrs:{"id":"navbar"}},[_c('Navbar',{attrs:{"title":"Purdue ROV - BattleStation"}})],1),_vm._v(" "),_c('div',{attrs:{"id":"main-container"}},[_c('div',{staticClass:"full-width full-height"},[_c('Card',{staticClass:"full-height full-width"},[_c('CameraView',{attrs:{"data":_vm.packets.dearclient.cameras,"packet":_vm.packets.dearflask}})],1)],1)])])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-8916279a"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8916279a", __vue__options__)
  } else {
    hotAPI.reload("data-v-8916279a", __vue__options__)
  }
})()}
},{"./components/CameraView.vue":66,"./components/Card.vue":67,"./components/Navbar.vue":68,"./main.js":73,"./packets.js":74,"vue":64,"vue-hot-reload-api":63}],66:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
    ...
    methods: {
        changePort: function changePort(newPort) {
            this.port = newPort;
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)((0, _entries2.default)(this.data)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        window: function (_window) {
            ...
            var win = new BrowserWindow({ width: 1000, height: 800 });
        ...
        refresh: function refresh() {
            ...
            var prev_port = this.port;
            this.port = 0;

            setTimeout(function () {
                _this.port = prev_port;
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"camera-view"}},[_c('div',{staticClass:"image"},[_c('img',{style:(_vm.transform(_vm.flipped[_vm.port])),attrs:{"src":_vm.source}})]),_vm._v(" "),_c('div',{staticClass:"buttons"},_vm._l((_vm.data),function(cam,name){return _c('button',{directives:[{name:"show",rawName:"v-show",value:(cam.status !== 'killed'),expression:"cam.status !== 'killed'"}],key:name,class:cam.status,on:{"click":function($event){_vm.changePort(cam.port)}}},[_vm._v(" "+_vm._s(name)+" ")])})),_vm._v(" "),_c('div',{staticClass:"control-buttons"},[_c('button',{staticClass:"control-button",on:{"click":_vm.window}},[_vm._v("draw")]),_vm._v(" "),_c('button',{staticClass:"control-button",attrs:{"id":"flip"},on:{"click":_vm.flip}},[_vm._v("⤽")]),_vm._v(" "),_c('button',{staticClass:"control-button",attrs:{"disabled":_vm.refreshing},on:{"click":_vm.refresh}},[_vm._v("⟳")])])])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-311402b1"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-311402b1", __vue__options__)
  } else {
    hotAPI.rerender("data-v-311402b1", __vue__options__)
  }
})()}
},{"babel-runtime/core-js/get-iterator":1,"babel-runtime/core-js/object/entries":3,"babel-runtime/helpers/slicedToArray":4,"vue":64,"vue-hot-reload-api":63}],67:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"container"}},[_c('div',{attrs:{"id":"card"}},[_c('div',{style:({backgroundColor: _vm.color}),attrs:{"id":"main-container"}},[(_vm.title !== undefined)?_c('div',{attrs:{"id":"title"}},[_vm._v(_vm._s(_vm.title))]):_vm._e(),_vm._v(" "),_c('div',{attrs:{"id":"padding"}},[_vm._t("default")],2)])])])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-6b999297"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6b999297", __vue__options__)
  } else {
    hotAPI.rerender("data-v-6b999297", __vue__options__)
  }
})()}
},{"vue":64,"vue-hot-reload-api":63}],68:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav',{attrs:{"id":"navbar"}},[_c('div',{staticClass:"nav-wrapper"},[_c('span',{attrs:{"id":"title"}},[_vm._v(_vm._s(_vm.title))])])])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-11e39852"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-11e39852", __vue__options__)
  } else {
    hotAPI.rerender("data-v-11e39852", __vue__options__)
  }
})()}
},{"vue":64,"vue-hot-reload-api":63}],69:[function(require,module,exports){
/*
**************************************************************************************************
...
function Gamepad() {
    ...
    this.setButtonLast = function(key, init = false) {
        //is called right before updating buttons
        if (init) {
            //init = true when gamepad is being mapped out; user shouldn't worry about it
    ...
    this.getButtonLastPress = function(key) {
        //allows for user to see/operate off of last press, if desired
        return buttons_last[key].val;
    };

    this.setStatusChange = function(key) {
        //this sets the pressed and released characteristics for each button
    ...
    this.setDisplace = function(key, x, y) {
        //the initial value of the joysticks are considered their 'error'
        axes_off[key] = { x: x, y: y };
    };

    this.getDisplace = function() {
        //allows user to see what the displacement values are, if desired
        return axes_off;
    };

    this.axesAdjust = function(key, x, y) {
        //calculates the polar coordinates, and scales the axes based off of displacement
    ...
    this.set = function(done) {
        //waits until it sees a gamepad with a button pressed, and sets it as the desired controller
        var monitor = window.setInterval(
            function() {
                ...
                for (var i = 0; i < chk.length; i++) {
                    ...
                    if (gp.ready) {
                        //if gamepad matches a known layout, accept the chosen gamepad
    ...
    this.map = function(id) {
        //maps the gamepad, and the related functions unless they've been defined for the button before
        console.log('Matching...');
        gp.id = id;
        var match = false;
        layouts.forEach(layout => {
            Object.keys(layout.id).forEach(function(i_key, j) {
                console.log(i_key);
                if (id == layout.id[i_key]) {
                    match = true;
                    gp.layout = layout;
                    gp.b_len = layout.buttons.length;
                    var name = '';
                    for (var i = 0; i < gp.b_len; i++) {
                        name = layout.buttons[i].name;
                    ...
                    var cur_index = -1;
                    var which = '';
                    gp.a_len = layout.axes.length;
                    for (var i = 0; i < gp.a_len; i++) {
                        name = layout.axes[i].name;
                        which = layout.axes[i].which;
                        cur_index = layout.axes[i].index;
        ...
        if (!gp.ready) {
            if (match) {
                console.log(
                    "The library recognized the gamepad, but didn't map it... Broken? :/"
                );
            } else {
                console.log('The chosen gamepad did not match the library.');
            }
        } else {
            //NO BIND
            //bind.activate();
    ...
    this.get_current = function(message) {
        ...
        if (read != undefined && gp.i_use != undefined) {
            ...
            for (var i = 0; i < gp.a_len; i++) {
                name = gp.layout.axes[i].name;
                which = gp.layout.axes[i].which;
                cur_index = gp.layout.axes[i].index;

                temp_axes[which][name] = read.axes[cur_index];
            }

            Object.keys(gp.axes).forEach(function(key_a, i) {
                gp.axes[key_a] = gp.axesAdjust(
                    key_a,
                    temp_axes[key_a].x,
                    temp_axes[key_a].y
                );
...
},{"./layouts.json":70}],70:[function(require,module,exports){
module.exports=[
    {
        "name": "Linux Xbox and Rock Candy Controller",
        "id": [
        ...
        "axes": [
            { "index": 0, "name": "x", "where": "axes", "which": "left" },
            { "index": 1, "name": "y", "where": "axes", "which": "left" },
            { "index": 3, "name": "x", "where": "axes", "which": "right" },
            { "index": 4, "name": "y", "where": "axes", "which": "right" }
        ],
        "buttons": [
            { "index": 0, "base": 0, "max": 1, "name": "a", "where": "buttons" },
            { "index": 1, "base": 0, "max": 1, "name": "b", "where": "buttons" },
            { "index": 2, "base": 0, "max": 1, "name": "x", "where": "buttons" },
            { "index": 3, "base": 0, "max": 1, "name": "y", "where": "buttons" },
            { "index": 4, "base": 0, "max": 1, "name": "lb", "where": "buttons" },
            { "index": 5, "base": 0, "max": 1, "name": "rb", "where": "buttons" },
            { "index": 8, "base": 0, "max": 1, "name": "home", "where": "buttons" },
            { "index": 2, "base": -1, "max": 1, "name": "lt", "where": "axes" },
            { "index": 5, "base": -1, "max": 1, "name": "rt", "where": "axes" },
            { "index": 6, "base": 0, "max": 1, "name": "slct", "where": "buttons" },
            { "index": 7, "base": 0, "max": 1, "name": "strt", "where": "buttons" },
            { "index": 9, "base": 0, "max": 1, "name": "lpress", "where": "buttons" },
            { "index": 10, "base": 0, "max": 1, "name": "rpress", "where": "buttons" },
            { "index": 7, "base": 0, "max": -1, "name": "up", "where": "axes" },
            { "index": 7, "base": 0, "max": 1, "name": "down", "where": "axes" },
            { "index": 6, "base": 0, "max": -1, "name": "left", "where": "axes" },
            { "index": 6, "base": 0, "max": 1, "name": "right", "where": "axes" }
        ]
    },
    {
        "name": "Linux Xbox Controller 2",
        "id": [
            "Holtek Controller (STANDARD GAMEPAD Vendor: 045e Product: 028e)",
            "Microsoft Controller (STANDARD GAMEPAD Vendor: 045e Product: 02d1)"
        ],
        "axes": [
            { "index": 0, "name": "x", "where": "axes", "which": "left" },
            { "index": 1, "name": "y", "where": "axes", "which": "left" },
            { "index": 2, "name": "x", "where": "axes", "which": "right" },
            { "index": 3, "name": "y", "where": "axes", "which": "right" }
        ],
        "buttons": [
            { "index": 0, "base": 0, "max": 1, "name": "a", "where": "buttons" },
            { "index": 1, "base": 0, "max": 1, "name": "b", "where": "buttons" },
            ...
            { "index": 4, "base": 0, "max": 1, "name": "lb", "where": "buttons" },
            { "index": 5, "base": 0, "max": 1, "name": "rb", "where": "buttons" },
            { "index": 6, "base": 0, "max": 1, "name": "lt", "where": "buttons" },
            { "index": 7, "base": 0, "max": 1, "name": "rt", "where": "buttons" },
            { "index": 8, "base": 0, "max": 1, "name": "slct", "where": "buttons" },
            { "index": 9, "base": 0, "max": 1, "name": "strt", "where": "buttons" },
            { "index": 10, "base": 0, "max": 1, "name": "lpress", "where": "buttons" },
            { "index": 11, "base": 0, "max": 1, "name": "rpress", "where": "buttons" },
            { "index": 12, "base": 0, "max": 1, "name": "up", "where": "buttons" },
            { "index": 13, "base": 0, "max": 1, "name": "down", "where": "buttons" },
            { "index": 14, "base": 0, "max": 1, "name": "left", "where": "buttons" },
            { "index": 15, "base": 0, "max": 1, "name": "right", "where": "buttons" },
            { "index": 16, "base": 0, "max": 1, "name": "home", "where": "buttons" }
        ]
    },
    {
        "name": "macOS Rock Candy Controller",
        "id": [
            "Rock Candy Gamepad for Xbox 360 (Vendor: 0e6f Product: 011f)"
        ],
        "axes": [
            { "index": 0, "name": "x", "where": "axes", "which": "left" },
            { "index": 1, "name": "y", "where": "axes", "which": "left" },
        ...
        "buttons": [
            ...
            { "index": 4, "base": 0, "max": 1, "name": "lb", "where": "buttons" },
            { "index": 5, "base": 0, "max": 1, "name": "rb", "where": "buttons" },
            { "index": 6, "base": 0, "max": 1, "name": "lpress", "where": "buttons" },
            { "index": 7, "base": 0, "max": 1, "name": "rpress", "where": "buttons" },
            { "index": 8, "base": 0, "max": 1, "name": "strt", "where": "buttons" },
            { "index": 9, "base": 0, "max": 1, "name": "slct", "where": "buttons" },
            { "index": 10, "base": 0, "max": 1, "name": "home", "where": "buttons" },
            { "index": 11, "base": 0, "max": 1, "name": "up", "where": "buttons" },
            { "index": 12, "base": 0, "max": 1, "name": "down", "where": "buttons" },
            { "index": 13, "base": 0, "max": 1, "name": "left", "where": "buttons" },
            { "index": 14, "base": 0, "max": 1, "name": "right", "where": "buttons" },
            { "index": 5, "base": -1, "max": 1, "name": "rt", "where": "axes" },
            { "index": 2, "base": -1, "max": 1, "name": "lt", "where": "axes" }
        ]
    },
    {
        "name": "Windows Standard Xbox Controller",
        "id": [
            "Xbox 360 Controller (XInput STANDARD GAMEPAD)"
        ],
        "buttons": [
            {"where": "buttons", "name": "a", "index": 0, "base": 0, "max": 1},
            {"where": "buttons", "name": "b", "index": 1, "base": 0, "max": 1},
            {"where": "buttons", "name": "x", "index": 2, "base": 0, "max": 1},
            {"where": "buttons", "name": "y", "index": 3, "base": 0, "max": 1},
            {"where": "buttons", "name": "lb", "index": 4, "base": 0, "max": 1},
            {"where": "buttons", "name": "rb", "index": 5, "base": 0, "max": 1},
            {"where": "buttons", "name": "lt", "index": 6, "base": 0, "max": 1},
            {"where": "buttons", "name": "rt", "index": 7, "base": 0, "max": 1},
            {"where": "buttons", "name": "slct", "index": 8, "base": 0, "max": 1},
            {"where": "buttons", "name": "strt", "index": 9, "base": 0, "max": 1},
            {"where": "buttons", "name": "lpress", "index": 10, "base": 0, "max": 1},
            {"where": "buttons", "name": "rpress", "index": 11, "base": 0, "max": 1},
            {"where": "buttons", "name": "up", "index": 12, "base": 0, "max": 1},
            {"where": "buttons", "name": "down", "index": 13, "base": 0, "max": 1},
            {"where": "buttons", "name": "left", "index": 14, "base": 0, "max": 1},
            {"where": "buttons", "name": "right", "index": 15, "base": 0, "max": 1}
        ],
        "axes": [
...
},{"./App2.vue":65,"vue":64}],72:[function(require,module,exports){
const keyCodeMap = {
    "0":48,
    "1":49,
    "2":50,
...
},{"./gamepad":69,"./keyboard":72}],74:[function(require,module,exports){
module.exports = {
    dearflask: {
        thrusters: {
            desired_thrust: [
